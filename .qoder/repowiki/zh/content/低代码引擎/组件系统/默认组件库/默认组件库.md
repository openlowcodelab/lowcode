...
```mermaid
graph TB
A["默认组件库<br/>H.LowCode.Components.Defaults"] --> B["_Imports.razor<br/>集中引入命名空间"]
...
subgraph "默认组件库"
CL["H.LowCode.Components.Defaults<br/>组件集合"]
...
图表来源 
- [README.md:14-20](file://README.md#L14-L20)
- [H.LowCode.Components.Defaults.csproj:10-14](file://src/LowCode/Common/H.LowCode.Components.Defaults/H.LowCode.Components.Defaults.csproj#L10-L14)
...
```mermaid
graph LR
Defaults["H.LowCode.Components.Defaults"] --> CB["H.LowCode.ComponentBase"]
