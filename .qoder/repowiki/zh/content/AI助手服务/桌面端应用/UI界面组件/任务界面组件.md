...
## 更新摘要
**变更内容**   
- 新增工作流创建界面，支持多步骤工作流配置和步骤管理
- 实现基于分类的筛选功能，采用芯片式按钮设计，支持动态分类管理
- 改进任务卡片布局，显示来源类型指示器（💬提示词、🔀工作流）和执行模式显示（👆手动/🤖自动）
- 增强分类管理服务集成，支持分类的添加、编辑、删除和筛选功能
- 完善工作流步骤管理，支持添加、删除和步骤验证功能
- 优化用户体验，提供直观的创建方式和执行模式选择
...
**最新更新** 新增了工作流创建界面、分类筛选、来源类型指示器和执行模式显示等增强功能，显著提升了用户操作体验和任务管理能力。
...
**图表来源**
- [TasksView.axaml:1-596](file://src/Host/H.AppLab.Desktop/Views/TasksView.axaml#L1-L596)
...
章节来源
- [Tasks.razor:1-1425](file://src/Agent/Assistant/H.Assistant.Web/Pages/Tasks.razor#L1-L1425)
...
- 提供 ObservableCollection<CategoryDto> 用于界面实时更新。
