...
- [renderengine.css](file://src/LowCode/RenderEngine/H.LowCode.RenderEngine/wwwroot/renderengine.css)
...
- 职责：
  - 引入主题 CSS 资源（_content/H.LowCode.RenderEngine/renderengine.css）。
  - 继承布局基类，获取并转换菜单数据。
  - 使用默认布局组件渲染页面框架。
- 关键点：
