...
public class CategoryAppService : ApplicationService, ICategoryAppService
{
    ...
    public async Task<BaseOutput<List<CategoryDto>>> GetListAsync()
    {
        ...
        return new() { Data = list.Select(x => _objectMapper.Map<CategoryEntity, CategoryDto>(x)).ToList() };
    }
    ...
    public async Task<BaseOutput<CategoryDto>> CreateAsync(CreateCategoryDto input)
    {
        ...
        return new() { Data = _objectMapper.Map<CategoryEntity, CategoryDto>(entity) };
    }
