...
public class FormDataAppService : ApplicationService, IFormDataAppService
{
    ...
    public async Task<BaseOutput<FormDataDto>> GetAsync(string appId, string pageId, string id)
    {
        ...
        if (string.IsNullOrEmpty(id))
        {
            ...
            return BaseOutput<FormDataDto>.Ok(defaultDto);
        }
        ...
        return BaseOutput<FormDataDto>.Ok(dto);
    }
    ...
    public async Task<BaseOutput<bool>> DeleteAsync(string appId, string pageId, string id)
    {
        ...
        return BaseOutput<bool>.Ok(await _formDataRepository.DeleteAsync(formPageSchema.DataSource.DataSourceValue, id));
    }
}
