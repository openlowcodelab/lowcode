...
/// </summary>
public class DesignEngineCurrentApp : ICurrentApp
{
    private readonly IHttpContextAccessor _httpContextAccessor;
    private readonly ILogger<DesignEngineCurrentApp> _logger;
    private string? _currentAppId;

    public DesignEngineCurrentApp(
        IHttpContextAccessor httpContextAccessor,
        ILogger<DesignEngineCurrentApp> logger)
    {
