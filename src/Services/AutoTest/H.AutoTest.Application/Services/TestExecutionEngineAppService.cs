...
{    
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var templateCase = await _projectCaseService.GetByIdAsync(testCase.TemplateId);
    ...
    /// 获取服务端点
    /// </summary>
    private string GetServiceEndpoint(EnvironmentDto environment, string serviceId)
    {
