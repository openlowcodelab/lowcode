...
public class ApprovalDefinitionAppService : ApplicationService, IApprovalDefinitionAppService
{
    ...
    public async Task<BaseOutput<ApprovalDefinitionDto>> CreateAsync(CreateApprovalDefinitionDto input)
    {
        ...
        entity = await _definitionRepository.InsertAsync(entity);
    ...
    public async Task<BaseOutput<ApprovalDefinitionDto>> UpdateAsync(UpdateApprovalDefinitionDto input)
    {
        ...
        entity = await _definitionRepository.UpdateAsync(entity);
    ...
    {
        return Task.FromResult(new BaseOutput<List<ApprovalTemplateDto>>(_templateProvider.GetTemplates()));
    }
