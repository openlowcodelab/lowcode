...
namespace H.Agent.Application.Workers;
...
public class ScheduledTaskWorker : BackgroundService
{
    ...
    public ScheduledTaskWorker(IServiceProvider serviceProvider)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                var taskService = scope.ServiceProvider.GetRequiredService<IAgentScheduledTaskAppService>();
