...
public interface IProjectServiceConfigAppService : IApplicationService
{
    ...
    /// 获取环境的所有服务配置
    /// </summary>
    Task<List<EnvironmentServiceConfigDto>> GetEnvironmentServiceConfigsAsync(long environmentId);
    
    /// <summary>
    /// 获取单个环境服务配置
    /// </summary>
    Task<EnvironmentServiceConfigDto?> GetEnvironmentServiceConfigAsync(long configId);
