...
/// Assistant 会话管理应用服务
/// </summary>
public class AssistantSessionAppService : ApplicationService, IAssistantSessionAppService
{
    private readonly IRepository<ChatSessionEntity, Guid> _sessionRepository;
    private readonly IRepository<ChatMessageEntity, Guid> _messageRepository;
    private readonly IMapper _objectMapper;
    private readonly IAsyncQueryableExecuter _asyncExecuter;
    
    public AssistantSessionAppService(
        IRepository<ChatSessionEntity, Guid> sessionRepository,
    ...
    public async Task<ChatSessionDto?> GetSessionAsync(Guid sessionId)
    {
        ...
        return _objectMapper.Map<ChatSessionEntity, ChatSessionDto>(session);
    }
    ...
    public async Task<List<ChatSessionDto>> GetSessionsAsync(string? filter = null)
    {
        ...
        return sessions
            .Select(s => _objectMapper.Map<ChatSessionEntity, ChatSessionDto>(s))
            .ToList();
    }
