      ...
      IProductAppService
{
    ...
    {
        var entity = await Repository.GetAsync(id);
        return BaseOutput<ProductDto>.Ok(entity.ToDto());
    }
    ...
    public async Task<BaseOutput<PagedResultDto<ProductDto>>> GetListAsync(ProductQueryDto input)
    {
        ...
        var dtos = entities.Select(e => e.ToDto()).ToList();
        return BaseOutput<PagedResultDto<ProductDto>>.Ok(new PagedResultDto<ProductDto>(totalCount, dtos));
    }
    ...
    public async Task<BaseOutput<ProductDetailDto>> GetDetailAsync(Guid id)
    {
        ...
        return BaseOutput<ProductDetailDto>.Ok(entity.ToDetailDto(skuDtos));
    }
}
      ...
      IProductSkuAppService
{
    ...
    {
        var entity = await Repository.GetAsync(id);
        return BaseOutput<ProductSkuDto>.Ok(entity.ToDto());
    }
    ...
    public async Task<BaseOutput<PagedResultDto<ProductSkuDto>>> GetListAsync(ProductSkuQueryDto input)
    {
        ...
        var dtos = entities.Select(e => e.ToDto()).ToList();
        return BaseOutput<PagedResultDto<ProductSkuDto>>.Ok(new PagedResultDto<ProductSkuDto>(totalCount, dtos));
    }
