...
public class NotificationRecordAppService : ApplicationService, INotificationRecordAppService
{
    ...
    public async Task<BaseOutput<PagedResultDto<NotificationRecordDto>>> GetMasterListAsync(NotificationRecordQueryDto input)
    {
        ...
        return BaseOutput<PagedResultDto<NotificationRecordDto>>.Ok(new PagedResultDto<NotificationRecordDto>(totalCount, dtos));
    }
    ...
    public async Task<BaseOutput<PagedResultDto<InAppRecordDto>>> GetInAppListAsync(ChannelRecordQueryDto input)
    {
        ...
        return BaseOutput<PagedResultDto<InAppRecordDto>>.Ok(new PagedResultDto<InAppRecordDto>(totalCount, dtos));
    }
    ...
    public async Task<BaseOutput<PagedResultDto<EmailRecordDto>>> GetEmailListAsync(ChannelRecordQueryDto input)
    {
        ...
        return BaseOutput<PagedResultDto<EmailRecordDto>>.Ok(new PagedResultDto<EmailRecordDto>(totalCount, dtos));
    }
    ...
    public async Task<BaseOutput<PagedResultDto<SmsRecordDto>>> GetSmsListAsync(ChannelRecordQueryDto input)
    {
        ...
        return BaseOutput<PagedResultDto<SmsRecordDto>>.Ok(new PagedResultDto<SmsRecordDto>(totalCount, dtos));
    }
    ...
    public async Task<BaseOutput<PagedResultDto<WebhookRecordDto>>> GetWebhookListAsync(ChannelRecordQueryDto input)
    {
        ...
        return BaseOutput<PagedResultDto<WebhookRecordDto>>.Ok(new PagedResultDto<WebhookRecordDto>(totalCount, dtos));
    }
}
