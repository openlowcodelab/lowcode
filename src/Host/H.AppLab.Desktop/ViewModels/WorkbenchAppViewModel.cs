...
/// </summary>
public partial class WorkbenchAppViewModel : ObservableObject
{
    ...
    public WorkbenchAppViewModel(IChatMessageAppService chatMessageAppService, ToastService toast,
        ChatViewModel chat)
    {
...
{
    private readonly WorkbenchAppViewModel _owner;

    public SessionItem(ChatDto dto, WorkbenchAppViewModel owner)
    {
        Dto = dto;
        _owner = owner;
    }
